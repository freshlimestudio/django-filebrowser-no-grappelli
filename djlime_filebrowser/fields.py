...
from djlime_filebrowser.functions import url_to_path
    ...
    def render(self, name, value, attrs=None):
        ...
        if value != "":
            try:
                ...
                pass
        return render_to_string("djlime_filebrowser/custom_field.html", locals())
...
try:
    ...
    add_introspection_rules([], ["^djlime_filebrowser\.fields\.FileBrowseField"])
except:
    pass
