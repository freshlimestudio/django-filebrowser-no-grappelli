...
from djlime_filebrowser.settings import VERSIONS
from djlime_filebrowser.conf import fb_settings
from djlime_filebrowser.functions import url_to_path, path_to_url, get_version_path, version_generator
...
def version(parser, token):
    """
    Displaying a version of an existing Image according to the predefined VERSIONS settings (see djlime_filebrowser settings).
