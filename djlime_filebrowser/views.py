...
def mkdir(request):
    ...
    return render_to_response('djlime_filebrowser/makedir.html', {
        'form': form,
        'query': query,
...
def upload(request):
    ...
    return render_to_response('djlime_filebrowser/upload.html', {
        'query': query,
...
def rename(request):
    ...
    return render_to_response('djlime_filebrowser/rename.html', {
        'form': form,
        'query': query,
...
def versions(request):
    ...
    return render_to_response('djlime_filebrowser/versions.html', {
